...
/obj/item/weapon/gun/rifle/m41a
	...
	starting_attachment_types = list(/obj/item/attachable/attached_gun/grenade, /obj/item/attachable/stock/rifle/collapsible, /obj/item/attachable/magnetic_harness)
